...
class EffectEnemyRushComponent :public EffekseerComponent
{
public:

	EffectEnemyRushComponent(Entity* entity)
	...
	void Play()override {
		...
		auto effects = GetEntity()->GetScene()->GetEffekseerResource()->GetResource(EffekseerResourceName::EnemyRush);
