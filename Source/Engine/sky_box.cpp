...
namespace cumulonimbus::component
{
	...
	void SkyBoxComponent::Load(ecs::Registry* registry)
	{
		...
		CreateTextures(GetRegistry()->GetScene()->GetFramework()->GetDevice(), "./Data/Assets/cubemap/skybox"); // Todo : SkyBoxÇÃTextureLoadï˚ñ@Ç™ñ¢íË
	...
	void SkyBoxComponent::CreateTextures(ID3D11Device* device, const char* filename)
	{
		for (int i = 0; i < 6; ++i)
		{
			std::string filename_s = filename;
