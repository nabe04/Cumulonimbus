...
void Transform::CreateScaling4x4()
{
	// Scaling
...
void Transform::CreateRotation4x4()
{
	// Rotation
...
void Transform::CreateTranslation4x4()
{
	// Parallel movement
...
void Transform::CalcModelCoordinateAxis(const XMFLOAT4X4& orientation)
{
...
void Transform::CalcWorldRotationAngle()
{
	{// Caluculate angle x
...
void Transform::CreateWorldTransformMatrix()
{
	CreateScaling4x4();
	CreateRotation4x4();
...
void Transform::CreateIdentity4x4(XMFLOAT4X4* convert)
{
...
void Transform::CalcLocalRotation_X()
{
...
void Transform::CalcLocalRotation_Y()
{
	XMFLOAT3 delta_angle = GetDeltaAngle();
...
void Transform::CalcLocalRotation_Z()
{
	XMFLOAT3 delta_angle = GetDeltaAngle();
...
XMMATRIX Transform::GetRotationMatrix(XMFLOAT3 axis, float angle/* degree */)
{
...
XMVECTOR Transform::GetRotationVec(XMFLOAT3 axis, float angle/* degree */)
{
	XMVECTOR axis_vec = XMLoadFloat3(&axis);
	XMVECTOR calc_val = XMQuaternionRotationAxis(axis_vec, XMConvertToRadians(angle));
	XMVECTOR store_vec = XMLoadFloat4(&local_quaternion);
