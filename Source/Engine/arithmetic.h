...
namespace arithmetic
{
	...
	* right : right vector
	*/
	DirectX::XMFLOAT3 CalcUpVec(const DirectX::XMFLOAT3& front, const DirectX::XMFLOAT3& right);
	...
	* front : front vector
	*/
	DirectX::XMFLOAT3 CalcRightVec(const DirectX::XMFLOAT3& up, const DirectX::XMFLOAT3& front);
	...
	* up    : up vector
	*/
	DirectX::XMFLOAT3 CalcFrontVec(const DirectX::XMFLOAT3& right, const DirectX::XMFLOAT3& up);

	DirectX::XMFLOAT3 SphereLinear(const DirectX::XMVECTOR v1, const DirectX::XMVECTOR v2, float s);
