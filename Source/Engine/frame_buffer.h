...
public:
	...
	void Activate(ID3D11DeviceContext* const immediate_context, ID3D11DepthStencilView* dsv = nullptr)
	{
		...
		if(dsv)
		{
			immediate_context->OMSetRenderTargets(1, render_target_view.GetAddressOf(), dsv);
		}
		else
		{
