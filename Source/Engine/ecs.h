...
//		class CameraOperationComponent;
//	}
//}
//
//
...
//
//CEREAL_REGISTER_TYPE(cumulonimbus::ecs::ComponentArray<cumulonimbus::component::AnimSpriteComponent>);
//CEREAL_REGISTER_POLYMORPHIC_RELATION(cumulonimbus::ecs::ComponentArrayBase, cumulonimbus::ecs::ComponentArray<cumulonimbus::component::AnimSpriteComponent>)
//
...
//
//CEREAL_REGISTER_TYPE(cumulonimbus::ecs::ComponentArray<cumulonimbus::component::CameraOperationComponent>);
//CEREAL_REGISTER_POLYMORPHIC_RELATION(cumulonimbus::ecs::ComponentArrayBase, cumulonimbus::ecs::ComponentArray<cumulonimbus::component::CameraOperationComponent>)