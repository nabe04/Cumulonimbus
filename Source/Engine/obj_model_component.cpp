...
namespace cumulonimbus::component
{
	...
	void ObjModelComponent::SetCenterWorldPos()
	{
		center_pos.x += GetRegistry()->GetComponent<TransformComponent>(GetEntity()).DeltaPosition().x;
		center_pos.y += GetRegistry()->GetComponent<TransformComponent>(GetEntity()).DeltaPosition().y;
		center_pos.z += GetRegistry()->GetComponent<TransformComponent>(GetEntity()).DeltaPosition().z;
	}
}
