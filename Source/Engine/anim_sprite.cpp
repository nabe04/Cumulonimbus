...
AnimSpriteComponent::AnimSpriteComponent(Entity* entity, ID3D11Device* device,
	...
	:SpriteComponent{ entity,device,filename,pivot_type,src_left,src_top,src_width,src_height }
{
	component_name = "AnimSprite";
...
void AnimSpriteComponent::Save(std::string file_path)
{
...
void AnimSpriteComponent::Load(Entity* entity, std::string file_path_and_name)
{
	{
...
//	{
//		const std::string file_path_and_name = file_path + typeid(AnimSpriteComponent).name() + ".json";
//		std::ofstream ofs(file_path_and_name);
//		cereal::JSONOutputArchive o_archive(ofs);
//		o_archive(
//			cereal::base_class<SpriteComponent>(this),
