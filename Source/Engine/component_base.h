...
namespace cumulonimbus::component
{
	...
	public:
		...
		ComponentBase(ecs::Registry* const registry,const ecs::Entity ent)
			: registry{ registry }
			, entity{ ent } {}
	...
	//	TransformComponent2(ecs::Registry* const registry, const ecs::Entity ent,
	...
	//	MeshComponent(ecs::Registry* const registry, const ecs::Entity ent, const std::string& name, int i_no, float f_no)
	//		: ComponentBase(registry, ent)
	//		, mesh_name{ name }
	//		, i_mesh_no{ i_no }
	//		, f_mesh_no{ f_no }
	...
	//	SpriteComponent(ecs::Registry* const registry, const ecs::Entity ent, int w, int h, bool f)
	//		:ComponentBase(registry, ent)
	//		, width{ w }
	//		, height{ h }
	//		, flg{ f }{}
