...
namespace cumulonimbus
{
	...
	namespace shader_asset
	{
		SingleColorAsset::SingleColorAsset()
			:ShaderAsset{}
		{
			cb_single_color = std::make_unique<buffer::ConstantBuffer<SingleColorCB>>(Locator::GetDx11Device()->device.Get());
		...
		{
			cb_single_color->Activate(Locator::GetDx11Device()->immediate_context.Get(), CBSlot_SingleColor);
		}

		void SingleColorAsset::UnbindCBuffer()
		{
			cb_single_color->Deactivate(Locator::GetDx11Device()->immediate_context.Get());
		}
