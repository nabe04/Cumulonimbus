...
void SceneTitle::InitializeScene()
{
	...
	//-- View --//
	view->SetViewInfo({ 0,60,-800 }, { .0f, .0f, .0f }, XMFLOAT3(.0f, 1.0f, .0f));
	...
	//house_1->GetComponent<TransformComponent>()->SetEyePosition({ 300,0,-500 });
	//house_1->GetComponent<TransformComponent>()->SetScale(0.3f);
	//house_1->GetComponent<TransformComponent>()->SetWorldRotation_X(-90);
	...
	//house_2->GetComponent<TransformComponent>()->SetEyePosition({ 0,0,0 });
	//house_2->GetComponent<TransformComponent>()->SetScale(0.25f);
	//house_2->GetComponent<TransformComponent>()->SetWorldRotation_X(-90);
	////house_1->GetComponent<MeshObject>()->SetSamplerState(RenderingSampleState::Linear_Wrap);
	...
	//house_3->GetComponent<TransformComponent>()->SetEyePosition({ -400,0,-500 });
	//house_3->GetComponent<TransformComponent>()->SetScale(0.25f);
	//house_3->GetComponent<TransformComponent>()->SetWorldRotation_X(-90);
	////house_1->GetComponent<MeshObject>()->SetSamplerState(RenderingSampleState::Linear_Wrap);
	...
	//stone_1->GetComponent<TransformComponent>()->SetEyePosition({ -300,0,500 });
	//stone_1->GetComponent<TransformComponent>()->SetScale({1,3.7,1});
	//stone_1->GetComponent<TransformComponent>()->SetWorldRotation({ -90,-127,0 });
	////house_1->GetComponent<MeshObject>()->SetSamplerState(RenderingSampleState::Linear_Wrap);
	...
	//stone_2->GetComponent<TransformComponent>()->SetEyePosition({ 700,0,500 });
	//stone_2->GetComponent<TransformComponent>()->SetScale({ 1,3.45f,0.8f });
	//stone_2->GetComponent<TransformComponent>()->SetWorldRotation({ -90,-60,0 });
	////house_1->GetComponent<MeshObject>()->SetSamplerState(RenderingSampleState::Linear_Wrap);
